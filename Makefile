...
release-readme:
	...
	echo "## Agelimit binaries" > ./builds/README.md
	echo "\nVersion: $(version)\n" >> ./builds/README.md
...
.PHONY: build-all build-linux-arm build-linux-arm64 build-linux-amd64 build-darwin-amd64 build-darwin-amd64 go-env go-arch version release-readme
